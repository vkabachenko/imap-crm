var TableAdvanced = function () {
    ...
    $('#sample_6 tfoot th').each( function () {
        var title = $('#sample_6 thead th').eq( $(this).index() ).text();
        if(title!='#' && title!='Действия'){
        $(this).html( '<div class="col-md-12"><input type="text" class="form-control" /></div>' );
        }
    } );
        ...
        var oTable = table.dataTable({
            ...
            "language": {
                ...
                "info": "Показано _START_ с _END_ по _TOTAL_ запсей",
                "infoEmpty": "Нет данных",
                "infoFiltered": "(filtered1 от _MAX_ всего запсей)",
                "lengthMenu": "Показать _MENU_ запсей",
                "search": "Поиск:",
